...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    private final ElevatorFeedforward elevatorFeedforward = new ElevatorFeedforward(KS,
            ...
            private final PIDController simElevatorController = new PIDController(1, 0,
            0);
    private final ElevatorFeedforward simElevatorFeedforward = new ElevatorFeedforward(0,
            0, 0, 0);


    public boolean usePID = true;

    // private final ElevatorSim elevatorSim = new ElevatorSim(0.4, 0.1,
    //          DCMotor.getFalcon500(2), 0, 5.4, true, 0.1);
    ...
    public final MechanismLigament2d elevatorViz = elevRoot.append(new MechanismLigament2d("elevatorLigament",  2, 90, 70.0, new Color8Bit(Color.kBlanchedAlmond)));
    ...
    public void periodic() {
       if(Utils.isSimulation()){
        ...
        SmartDashboard.putNumber("elev sim position", elevatorSim.getPositionMeters());
        ...
        elevatorMotor.setPosition(simEncoder);
            ...
            //elevatorMotor.setVoltage(getEffort() * -1.0);//the old way (Using PID & feedforward)
